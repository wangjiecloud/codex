    ...
    <>
      ...
      {showAdd && (
        <div className="px-4 py-3 border-b border-[#1e2332] bg-[#1a1f2e] flex-shrink-0">
          <div className="mb-2">
            <input
              className="w-full bg-[#0f1219] border border-[#2a3045] rounded-lg px-2 py-1.5 text-xs text-white placeholder-gray-600 focus:outline-none focus:border-[#f5a623]/50"
...
function buildEdge(raw: {
  ...
  const c = colors[raw.layer] ?? "#6b7280";
  return {
    id: raw.id,
    source: raw.source,
    target: raw.target,
